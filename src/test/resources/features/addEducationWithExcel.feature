...
Feature: Add Education Test - Excel File
  ...
  Scenario Outline:
    ...
    Examples:
      ...
      | src/test/resources/LoginList.xlsx | QaTeam3   | 1         | module Name |
      | src/test/resources/LoginList.xlsx | QaTeam3   | 2         | module Name |
      | src/test/resources/LoginList.xlsx | QaTeam3   | 5         | module Name |
