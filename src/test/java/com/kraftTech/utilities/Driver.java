                ...
                case "remote_chrome":
                    ...
                    try{
                       //   driverPool.set(new RemoteWebDriver(new URL("http://localhost:4444/wd/hub"),chromeOptions));
                        driverPool.set(new RemoteWebDriver(new URL("http://192.168.1.20:4444/wd/hub"),chromeOptions));
                ...
                case "remote_firefox":
                    ...
                    try{
                      //   driverPool.set(new RemoteWebDriver(new URL("http://localhost:4444/wd/hub"),firefoxOptions));
                        driverPool.set(new RemoteWebDriver(new URL("http://192.168.1.20:4444/wd/hub"),firefoxOptions));
                    }catch (MalformedURLException e){
                        e.printStackTrace();
                    }
                    break;
